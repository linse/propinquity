...
public class XPan { 
  ...
  void nodeDiscover() { parent.println("discovering nodes from xpan."); xbee.nodeDiscover(); }
  
  void stop() { xbee.stopXBee(); }
  
  void broadcastProxConfig(int stepLength) { parent.println("broadcasting prox config"); broadcast(getProxConfigPacket(stepLength)); }
