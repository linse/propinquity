 ...
 *
 * <p>The package also contains the classes which represent the actual hardware. Currently these are {@link propinquity.hardware.Glove} and {@link propinquity.hardware.Patch}.</p>
 *
 * <p>The {@link propinquity.hardware.Packet} class and the {@link propinquity.hardware.PacketType} enum, specify together the current packet format used for communication.</p>
 *
